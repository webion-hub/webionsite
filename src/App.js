    ...
    <CustomAppBar>
          ...
          >
            <Box
              sx={{
                height: "1200px",
                width: "1200px",
                backgroundColor: alpha(outerTheme.palette.primary.dark, 0.1),
      ...
      <Paper
				...
				sx={{
					width: "100vw", 
					height: 400, 
					borderTop: `1px solid ${alpha(outerTheme.palette.primary.main, 0.25)}`
				}}
			>	
